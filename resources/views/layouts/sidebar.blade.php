        ...
        <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
            <div class="flex-1 px-3 space-y-1 bg-gray-50 divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                <ul class="pb-2 space-y-2">
                    @auth
                    <li>
                        <a href="{{ route('dashboard') }}" class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-blue-100 group dark:text-gray-200 dark:hover:bg-gray-700 @if(request()->segment(1) == 'dashboard') bg-blue-100 dark:bg-gray-700 @endif">
                            <svg class="w-6 h-6 transition duration-75 group-hover:text-blue-500 dark:text-gray-400 dark:group-hover:text-white @if(request()->segment(1) == 'dashboard') text-blue-500 @else text-gray-500 @endif" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
